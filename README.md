...
* Note: When flashing to a USB stick, you must change the name of the EFI file to BOOTX64.EFI (which is located in EFI/BOOT on the EFI partition of the USB stick).
